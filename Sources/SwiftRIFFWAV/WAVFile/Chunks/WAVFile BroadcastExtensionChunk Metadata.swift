...
extension WAVFile.BroadcastExtensionChunk {
    public struct Metadata {
        ...
        public var originatorReferenceData: Data {
            didSet {
                if originatorReferenceData.count > 32 {
                    originatorReferenceData = originatorReferenceData.prefix(32)
                }
                if originatorReferenceData.count < 32 {
                    originatorReferenceData = originatorReferenceData.padding(toLength: 32, withPad: 0x00)
                }
            }
        }
        ...
        public init(
            ...
            bwavDescriptionData = description
                .prefix(256)
                .data(using: .ascii)?
            ...
            originatorReferenceData = originatorReference
                .prefix(32)
                .data(using: .ascii)?
                .padding(toLength: 32, withPad: 0x00)
                ?? Data(repeating: 0x00, count: 32)
